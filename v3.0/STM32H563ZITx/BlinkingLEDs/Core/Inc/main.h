...
#define LED2_YELLOW_Pin LL_GPIO_PIN_4
...
#define LED1_GREEN_Pin LL_GPIO_PIN_0
...
#define LED3_RED_Pin LL_GPIO_PIN_4
#define LED3_RED_GPIO_Port GPIOG
#define UCPD_FLT_Pin LL_GPIO_PIN_7
#define UCPD_FLT_GPIO_Port GPIOG
#define UCDP_DBn_Pin LL_GPIO_PIN_9
...
#define ARD_D1_TX_Pin LL_GPIO_PIN_6
#define ARD_D1_TX_GPIO_Port GPIOB
#define ARD_D0_RX_Pin LL_GPIO_PIN_7
