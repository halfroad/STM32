...
void MX_FREERTOS_Init(void) {
  ...
  GreenLedEventCountingSemaphoreHandle = osSemaphoreNew(20, 20, &GreenLedEventCountingSemaphore_attributes);

  /* creation of RedLedEventCountingSemaphore */
  RedLedEventCountingSemaphoreHandle = osSemaphoreNew(10, 10, &RedLedEventCountingSemaphore_attributes);
